                            ...
                            <div class="tab-content trip-tab-form">
                                ...
                                <div class="tab-pane active"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="editor">{{ $region->description }}</textarea>
                                    </div>
                                </div>
                                {{-- end of general tab --}}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <textarea name="seo[meta_title]"
                                                      ...
                                                      id=""
                                                      cols="30"
                                                      rows="2">{{ $region->seo->meta_title ?? '' }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <textarea name="seo[meta_keywords]"
                                                      ...
                                                      id=""
                                                      cols="30"
                                                      rows="2">{{ $region->seo->meta_keywords ?? '' }}</textarea>
                                            {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text"
                                                   id="input-trip-name"
                                                   value="{{ $region->seo->canonical_url ?? '' }}"
                                                   class="form-control form-control-sm"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <textarea name="seo[meta_description]"
                                                      ...
                                                      id=""
                                                      cols="30"
                                                      rows="2">{{ $region->seo->meta_description ?? '' }}</textarea>
                                            {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                                        </div>
                                    </div>
                                    <div class="form-group row">
