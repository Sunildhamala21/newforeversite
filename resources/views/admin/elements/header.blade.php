        ...
        <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile kt-header-menu--layout-default ">
            <ul class="kt-menu__nav ">
                <li class="kt-menu__item kt-menu__item--submenu kt-menu__item--rel kt-menu__item--active"
                    ...
                    aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-text">{{ config('app.name') }}</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                </li>
            </ul>
        </div>
    </div>
                ...
                <div class="kt-quick-search kt-quick-search--dropdown kt-quick-search--result-compact" id="kt_quick_search_dropdown">
                    <form method="get" class="kt-quick-search__form">
                        <div class="input-group">
                            ...
                            <input type="text"
                                   class="form-control kt-quick-search __input"
                                   placeholder="Search...">
                ...
                <div class="kt-notification">
                    ...
                    <div class="kt-notification__custom kt-space-between">
                        ...
                        <a href="{{ route('auth.logout') }}"
                           style="width: 100%;"
                           class="btn btn-clean btn-sm btn-bold pull-right">Logout</a>
