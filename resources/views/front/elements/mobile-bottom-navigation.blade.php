<div class="fixed bottom-0 left-0 right-0 p-2 text-xs text-white border-t border-white/50 lg:hidden bg-primary">
    <div class="grid grid-cols-3">
        <a class="p-2 text-center rounded-sm @if (request()->routeIs('front.plantrip')) bg-green-600 @endif"
            href="{{ route('front.plantrip') }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                class="w-5 h-5 mx-auto mb-1" viewBox="0 0 16 16">
                <path
        ...
        <a class="p-2 text-center" href="{{ Setting::get('whatsapp') ?? '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                class="w-5 h-5 mx-auto mb-1" viewBox="0 0 16 16">
                <path
        ...
        @if (request()->routeIs('front.trips.show') && isset($trip))
            <a class="p-2 text-center bg-green-600 rounded-sm" href="{{ route('front.trips.booking', $trip ?? '') }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="w-5 h-5 mx-auto mb-1" viewBox="0 0 16 16">
                    <path
        ...
        @else
            <a class="p-2 text-center rounded-sm @if (request()->routeIs('front.contact.index')) bg-green-600 @endif"
